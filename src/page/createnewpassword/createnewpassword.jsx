...
paddingTop:calculateResponsiveFontSize(10)
        ...
        <Text style={[ {fontSize:calculateResponsiveFontSize(8), color:bgColor4, fontWeight:'500', marginBottom:1}]}>Create new password</Text>
  <Text style={styles.textContent}>Create new password</Text>
       
       <Stack mb="8">
        <Text style={styles.inputText}>Create new password</Text>
       <TextInput
          style={styles.input}
          placeholder="******"
...
<Text style={[styles.signupText, {fontSize:calculateResponsiveFontSize(5), color:bgColor2}]}>Resend OTP</Text>
